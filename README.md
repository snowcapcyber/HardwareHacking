...
%%
%%
\title{Introduction to Hardware Vulnerability Assessments (HVA)}
%%
%%
 \author{}
%%
%%
\institute{SnowCap Cyber Ltd, UK.\\  
EMail Address: \email{ab@snowcapcyber.com},\\ 
WWW Address: \texttt{http://www.snowcapcyber.com}}
%%
%%
\begin{figure}[t]
\includegraphics[width=30mm]{Images/merimetso.png}
\label{ngarch}
\end{figure}
%%
%%
...
\begin{tabularx}{\textwidth}{ |X| }
  \hline
\textbf{\small{Document Control:}} \\
  \hline
\begin{tabular}{ p{3.5cm} l}               
  \small{Version:}  & \small{1.1} \\ 
\end{tabular}\\ 
  \hline
\begin{tabular}{ p{3.5cm} l}               
 \small{ Date:}  & \small{1st December 2022}\\  
\end{tabular}\\ 
  \hline
\begin{tabular}{ p{3.5cm} l}               
\small{Document Ref. Num: }  & \small{/SNOWCAP/HVA/0001.1} \\ 
\end{tabular}\\ 
  \hline
\end{tabularx}\\
\end{tabular}
...
The ISO 27001 standard for ISO Information Security Management Systems defines a vulnerability as “\emph{a weakness of an asset or control that could potentially be exploited by one or more threats.}” Additionally, ISO further defines a threat as any “\emph{potential cause of an unwanted incident, which may result in harm to a system or organisation.}”\\
...
\begin{figure}[]
\includegraphics[width=110mm]{Images/concept.png}
\centering 
\label{Figure-1}
\caption{Security Assessment Concept Diagram}
\end{figure}
...
\begin{itemize}
\item \textbf{White-Box Testing} - Full disclosure about the target of evaluation  (ToE) is shared with the testers; this can include design documents and schematics as well as source code and compiled binaries. This type of testing confirms the efficacy of internal vulnerability assessment and management controls by identifying the existence of known vulnerabilities and common misconfigurations. White-Box testing can also include code-reviews. \\

\item \textbf{Grey-Box Testing} - Partial disclosure about the target of evaluation  (ToE) is shared with the testers; this can include some (but not all) design documents and schematics as well as source code and compiled binaries. This type of testing confirms the efficacy of internal vulnerability assessment and management controls by identifying the existence of known vulnerabilities and common misconfigurations. However, due to only partial disclosure of information relating to the Target of Evaluation (ToE) it can also result in vulnerabilities remaining undiscovered.\\

\item \textbf{Black-box testing} - No information is shared with the testers about the internals of the  target of evaluation  (ToE). This type of test more accurately models the risk faced from attackers. However, the lack of information can also result in vulnerabilities remaining undiscovered in the time allocated for testing.\\
\end{itemize}
